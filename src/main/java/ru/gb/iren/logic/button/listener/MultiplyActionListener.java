...
import ru.gb.iren.operation.Multiplication;
...
public class MultiplyActionListener implements ActionListener {
    ...
    public MultiplyActionListener(CalculatorLogic logic, JTextField valueField) {
        this.logic = logic;
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        logic.setOperation(new Multiplication());
